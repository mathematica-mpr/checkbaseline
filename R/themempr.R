theme_mpr <- function(base_size = 14,base_family = "sans") {
  ...
  theme_bw(base_size = base_size, base_family = base_family) +
    ...
    # Grid
    theme(panel.grid.major = element_line(color = grid, size = .25),
          panel.grid.minor = element_line(color = grid, size = .15, linetype = "dashed"),
    ...
    theme(
      plot.title = element_text(color = plot.title, hjust = 0, size = rel(1.5), face = "bold"),
